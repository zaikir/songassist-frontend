  ...
  const renderAvatar = () => (
    ...
    >
      <Avatar
        ...
        alt={user.name}
        sx={{ width: 1, height: 1, bgcolor: '#ec407a', color: 'white', fontSize: 26 }}
      >
        ...
        return (
          <MenuItem key={option.label}>
            ...
            >
              ...
              {/* {option.info && (
                <Label color="error" sx={{ ml: 1, pointerEvents: 'none' }}>
                  {option.info}
                </Label>
              )} */}
            </Link>
    ...
    <>
      ...
      >
        ...
        <Scrollbar>
          ...
          {renderList()}
          {/* 
          <Stack flex={1} direction="column" justifyContent="end" sx={{ px: 2.5, py: 3 }}>
            <UpgradeBlock />
          </Stack> */}
        </Scrollbar>
